...
| TimeContext                          | Clinical timelines and durations                                           | "Chronic", "3 months", "Seventh Decade"                                              | Time span (e.g., acute/chronic), Duration (e.g., 3 months), Temporal qualifier (e.g., early/late)                                    |
| LifestyleFactor                      | Diet, exercise, stress, habits                                             | High iodine diet, smoking                                                            | Factor type (e.g., diet, habit), Frequency/intensity, Duration, Impact on health (if known)                                          |
| EnvironmentalFactor                  | Radiation, pollution, geographic risks                                     | Fukushima exposure, high-altitude                                                    | Factor source (e.g., location, substance), Exposure level, Duration, Known associated conditions                                     |
| MedicalEvent                         | Events or states within clinical history                                   | Recurrence, Surgery, Remission                                                       | Event type (e.g., procedure, relapse), Timing (onset/offset), Outcome, Associated condition                                          |
| StudyDesign                          | Study design classification                                                | RCT, Meta-analysis, Cohort                                                           | Design type, Evidence strength level, Sample size (if known), Blinding/randomization info                                            |
| AccessType                           | Treatment accessibility                                                    | OTC, prescription-only                                                               | Access level (OTC, Rx, restricted), Regulatory region (e.g., FDA, EMA), Cost/access barriers                                         |
...
| GeneticVariant                       | SNPs, alleles, or mutations linked to HT risk or thyroid function.         | rs2476601, HLA-DR3 allele, FOXP3 variant                                             | Variant ID (rsID/allele), Variant type (SNP/CNV/allele), Parent gene, Risk direction (risk/protective), Effect size (OR/β if known)  |
| GutMicrobiotaTaxon                   | Bacterial taxa associated with HT or thyroid function.                     | Bacteroidetes, Firmicutes, Lactobacillus, Prevotella                                 | Taxon name, Taxonomic level (phylum/genus/species), Abundance direction (enriched/depleted in HT), Sample source (stool/oral)        |
